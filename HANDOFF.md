...
- **Decision:** token-diet history (`roym` x5, `<redacted>` x4 in old commits) left as-is — usernames/paths only, no secrets; not worth a public-history force-push rewrite.
